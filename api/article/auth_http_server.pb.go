...
type AuthServiceHTTPServer interface {
	...
	PostOneArticlePure(*api.Context, *GetOneArticlePureReq) *GetOneArticlePureResp
}
...
func RegisterAuthServiceHTTPServer(s *gin.Engine, srv AuthServiceHTTPServer) {
	...
	r.POST("/v1/get/article", _AuthService_PostOneArticlePure_HTTP_Handler(srv))
}
...
func _AuthService_PostOneArticlePure_HTTP_Handler(srv AuthServiceHTTPServer) func(g *gin.Context) {
	return func(g *gin.Context) {
		req := &GetOneArticlePureReq{}
		ctx := api.NewContext(g)
		resp := srv.PostOneArticlePure(&ctx, req)
		setRetOrigin(&ctx, resp)
	}
}
